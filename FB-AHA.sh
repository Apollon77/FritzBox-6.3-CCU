...
# --------------------------------------------------------------------------------
script="FB-AHA"
Debugmsg1=$Debugmsg1"Script-Version          : $0 v0.1.5 \n"
...
Debugmsg1=$Debugmsg1"Parameter SID           = $SID \n"
Debugmsg1=$Debugmsg1"Parameter devicesFBAHA  = $devicesFBAHA \n\n"
...
case $1 in
	...
	"switch")  		AIN=$2
					if [ $3 = "0" ] ; then
						...
						get_FBAHA_DEVICE_state
						set_CUxD_state $get_FBAHA_Power $4 $1
						...
						get_FBAHA_DEVICE_state
						set_CUxD_state $get_FBAHA_Celsius $4 $1
					elif [ $3 = "temperature2" ] ; then 
						get_FBAHA_DEVICE_state
						set_CUxD_temperature $get_FBAHA_Celsius $4 $1
					else
