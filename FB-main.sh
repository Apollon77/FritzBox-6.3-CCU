...
case $1 in
	...
	"WLANGast")		location="/upnp/control/wlanconfig3"
					...
					;;
	"DisallowWANAccess")	location="/upnp/control/x_hostfilter"
					uri="urn:dslforum-org:service:X_AVM-DE_HostFilter:1"
					if [ $2 = "0" ] || [ $2 = "1" ]; then
						Action='DisallowWANAccessByIP'
						set_TR064 NewIPv4Address $3 NewDisallow $2
					fi
					;;
	"GetWANAccess")		location="/upnp/control/x_hostfilter"
					uri="urn:dslforum-org:service:X_AVM-DE_HostFilter:1"
					Action='GetWANAccessByIP'
					SoapParam='NewDisallow'
					get_TR064 NewIPv4Address $2
					TR064=$(echo $TR064_temp | sed -n 's:.*<'$SoapParam'>\(.*\)</'$SoapParam'>.*:\1:p')
					Debugmsg1=$Debugmsg1"get_TR064     : $1/$2/$SoapParam = $TR064 \n"
					if [ $3 = "state" ]; then
	...
	"Status-Uptime") 	location="/upnp/control/deviceinfo"
					...
					;;
	"Status-Bytes-Send")		location="/upnp/control/wancommonifconfig1"
								uri="urn:dslforum-org:service:WANCommonInterfaceConfig:1"
								Action='GetTotalBytesSent'
								SoapParam='NewTotalBytesSent'
								get_TR064
								TR064=$(echo $TR064_temp | sed -n 's:.*<'$SoapParam'>\(.*\)</'$SoapParam'>.*:\1:p')
								Debugmsg1=$Debugmsg1"get_TR064	 : $1/$SoapParam = $TR064 \n"
								set_CCU_SysVar $TR064 $2 $1
								;;
	"Status-Bytes-Received")	location="/upnp/control/wancommonifconfig1"
								uri="urn:dslforum-org:service:WANCommonInterfaceConfig:1"
								Action='GetTotalBytesReceived'
								SoapParam='NewTotalBytesReceived'
								get_TR064
								TR064=$(echo $TR064_temp | sed -n 's:.*<'$SoapParam'>\(.*\)</'$SoapParam'>.*:\1:p')
								Debugmsg1=$Debugmsg1"get_TR064	 : $1/$SoapParam = $TR064 \n"
								set_CCU_SysVar $TR064 $2 $1
								;;
	"Status-Packets-Send")		location="/upnp/control/wancommonifconfig1"
								uri="urn:dslforum-org:service:WANCommonInterfaceConfig:1"
								Action='GetTotalPacketsSent'
								SoapParam='NewTotalPacketsSent'
								get_TR064
								TR064=$(echo $TR064_temp | sed -n 's:.*<'$SoapParam'>\(.*\)</'$SoapParam'>.*:\1:p')
								Debugmsg1=$Debugmsg1"get_TR064	 : $1/$SoapParam = $TR064 \n"
								set_CCU_SysVar $TR064 $2 $1
								;;
	"Status-Packets-Received")	location="/upnp/control/wancommonifconfig1"
								uri="urn:dslforum-org:service:WANCommonInterfaceConfig:1"
								Action='GetTotalPacketsReceived'
								SoapParam='NewTotalPacketsReceived'
								get_TR064
								TR064=$(echo $TR064_temp | sed -n 's:.*<'$SoapParam'>\(.*\)</'$SoapParam'>.*:\1:p')
								Debugmsg1=$Debugmsg1"get_TR064	 : $1/$SoapParam = $TR064 \n"
								set_CCU_SysVar $TR064 $2 $1
	...
	"WakeOnLan")	LOGIN
					...
					;;
	"WakeUpOnLan")	location="/upnp/control/hosts"
					uri="urn:dslforum-org:service:Hosts:1"
					TR064=$3
					if [ "$2" = "IP" ]; then
						Action='X_AVM-DE_GetSpecificHostEntryByIp'
						SoapParam='NewMACAddress'
						get_TR064 NewIPAddress $3
						TR064=$(echo $TR064_temp | sed -n 's:.*<'$SoapParam'>\(.*\)</'$SoapParam'>.*:\1:p')
						Debugmsg1=$Debugmsg1"get_TR064   : $1/$SoapParam = $TR064 \n"
					fi
					unset SoapParam
					Action='X_AVM-DE_WakeOnLANByMACAddress'
					set_TR064 NewMACAddress "$3"
					;;
	"MAC-by-IP")	location="/upnp/control/hosts"
					uri="urn:dslforum-org:service:Hosts:1"
					Action='GetSpecificHostEntryByIp'
					SoapParam='NewMACAddress'
					get_TR064 NewIPAddress $2
					TR064=$(echo $TR064_temp | sed -n 's:.*<'$SoapParam'>\(.*\)</'$SoapParam'>.*:\1:p')
					Debugmsg1=$Debugmsg1"get_TR064	 : $1/$SoapParam = $TR064 \n"
					;;
	...
	*)				Debugmsg1=$Debugmsg1"MAIN :  ERROR - Bitte wie folgt aufrufen: \n"
					...
					Debugmsg1=$Debugmsg1"        ./FB-main.sh DisallowWANAccess [0|1] [IP-Adresse]\n"
					Debugmsg1=$Debugmsg1"        ./FB-main.sh GetWANAccess [IP-Adresse] [state] [CUX2801xxx:x] -> Status an CUxD-Remote (28)\n"
					Debugmsg1=$Debugmsg1"        ./FB-main.sh GetWANAccess [IP-Adresse] [state1] [Name_der_SysVar] -> SysVar/Logikwert (true/false)\n"
					Debugmsg1=$Debugmsg1"        ./FB-main.sh WakeUpOnLan [IP|MAC] [IP-Adresse|MAC-dresse]\n"
					Debugmsg1=$Debugmsg1"        ./FB-main.sh MAC-by-IP [IP-Adresse]\n"
